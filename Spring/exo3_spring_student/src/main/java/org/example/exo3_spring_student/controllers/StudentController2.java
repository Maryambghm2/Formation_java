...
//    public String searchName(@RequestParam(value = "lastname", required = false) String lastname, Model model) {
...
//    public String createStudent(@RequestParam("lastname") String lastname,
//                                @RequestParam("firstname") String firstname,
//                                @RequestParam("age") int age,
//                                @RequestParam("mail") String mail,
//                                Model model) {
//        Student newStudent = studentService.create(lastname, firstname, age, mail);
