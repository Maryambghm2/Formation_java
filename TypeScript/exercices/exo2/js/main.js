...
const contact1 = createContact("toto", "titi", new Date("2010-10-10"), "toto@gmail.com", "06-10-65-40-41", "url_avatar.jpg");
const contact2 = createContact("tata", "titi", new Date("2000-05-21"), "tata@gmail.com", "06-42-40-78-12");
const contact3 = createContact("tutu", "tata", new Date("2010-10-10"), "tutu@gmail.com", "06-01-74-20-41");
